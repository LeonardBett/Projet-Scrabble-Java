...
```
cd existing_repo
git remote add origin https://gitlab.emi.u-bordeaux.fr/pdp-2026/scrabble-java.git
git branch -M main
...
* [Set up project integrations](https://gitlab.emi.u-bordeaux.fr/pdp-2026/scrabble-java/-/settings/integrations)
