...
De plus, il y a un moyen montrer dans l'artcile originel publiant l'idée du GADDAG, de reduire la mémoire utilisé par le GADDAG. 
Le moyen utiliser est de reduire le nombre de sortie dpour chaque mot en reliant les répétitions inutiles de fin de mots comme le montre cette exemple fait pour le mot CARE.
