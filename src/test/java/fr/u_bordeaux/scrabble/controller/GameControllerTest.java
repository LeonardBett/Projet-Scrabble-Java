...
class GameControllerTest {
    ...
    void handlePlayerMoveShouldRejectInvalidPerpendicularWord() throws Exception {
        ...
        Move move = Move.createPlay(alice, List.of(new Tile('R')), new Point(7, 7), Direction.HORIZONTAL);

        RuntimeException error = assertThrows(RuntimeException.class, () -> controller.handlePlayerMove(move));
    ...
    void handlePlayerMoveShouldLoadDictionaryWhenMissing() {
        ...
        alice.getRack().setTiles(new ArrayList<>(List.of(
            new Tile('R'), new Tile('U'), new Tile('E'), new Tile('S'))));
    ...
    void runCliShouldHandleAllHumanActionsThenQuit() throws Exception {
        ...
        alice.getRack().setTiles(new ArrayList<>(List.of(
                new Tile('A'), new Tile('A'), new Tile('B'), new Tile('C'), new Tile('D'), new Tile('E'), new Tile('F'))));
        bob.getRack().setTiles(new ArrayList<>(List.of(
                new Tile('A'), new Tile('B'), new Tile('C'), new Tile('D'), new Tile('E'), new Tile('F'), new Tile('G'))));
...
@Test
    ...
    void runCliShouldHandleAiTurnFailureAndContinue() throws Exception {
        ...
        runCliWithInput(controller, "6\no\n");
        assertTrue(game.getCurrentPlayer() instanceof HumanPlayer || game.getCurrentPlayer() instanceof AIPlayer);
    }
