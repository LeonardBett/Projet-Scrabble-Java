...
class DAWGNodeTest {
    ...
    /**
     * Test that a DAWGNode is correctly initialized with its character
    ...
    /**
     * Test that two nodes are considered equal if they have the same content,
     * same finite status, and identical children. This is critical for DAWG minimization.
     */
    @Test
