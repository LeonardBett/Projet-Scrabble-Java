...
class DAWGTest {
    ...
    /**
     * Test that words added in alphabetical order are correctly stored
     * and can be retrieved using contains.
     */
    @Test
    ...
    /**
     * Test that findWordsWithRackAndHook finds all valid words formable
    ...
    /**
     * Test that the hook constraint is respected: only words containing
     * the hook letter should be returned.
     */
    @Test
    ...
    /**
     * Test that the Joker (represented by a space ' ') can replace any letter
     * to form words.
     */
    @Test
