...
public class DAWGNode {
  ...
  /**
   * Crucial for minimization: identifies identical structures. Two nodes are equal if they have the
   * same content, same finite status, and identical child transitions.
   */
  @Override
