...
public class ScorePanel extends VBox {
  ...
  public ScorePanel() {
    ...
    this.bagInfoLabel = new Label(I18n.translate("score.remainingTiles", 102));
    this.currentPlayerLabel = new Label(I18n.translate("score.currentTurn", "—"));
  ...
  private void initializeUi() {
    ...
    Label title = new Label(I18n.translate("score.title"));
  ...
  public void updateBagInfo(int remainingTiles) {
    bagInfoLabel.setText(I18n.translate("score.remainingTiles", remainingTiles));
  }
  ...
  public void highlightCurrentPlayer(int playerIndex, String playerName) {
    ...
    currentPlayerLabel.setText(I18n.translate("score.currentTurn", playerName));
  }
  ...
  private void refreshBlitzDisplay() {
    ...
    StringBuilder sb = new StringBuilder(I18n.translate("score.remainingTimeHeader") + "\n");
