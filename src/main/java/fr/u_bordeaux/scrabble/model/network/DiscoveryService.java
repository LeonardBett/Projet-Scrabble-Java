...
public class DiscoveryService {
    ...
    private static final int DEFAULT_UDP_PORT = 12346;
    private static final int DEFAULT_TCP_PORT = 12345;
    ...
    // Start the broadcast
    // Message format: "SCRABBLE_SERVER;serverName;PortTCP"
    public void startBroadcasting(String serverName, int tcpPort){
        ...
        broadCastThread = new Thread(() -> {
            try (DatagramSocket broadcastSocket = new DatagramSocket()) {
                ...
                DatagramPacket packet = new DatagramPacket(byteMessage, byteMessage.length, destinationAddress, DEFAULT_UDP_PORT);
    ...
    // Start the broadcast with default port
    ...
    public void startListening() {
        ...
        new Thread(() -> {
                try {
                    ...
                    listenSocket = new DatagramSocket(DEFAULT_UDP_PORT, InetAddress.getByName("0.0.0.0"));
    ...
    // Process a packet's message, by adding it to the servers Map if not present, or else updating this server timeout
    ...
    // Return the list of known server (and remove expired one)
