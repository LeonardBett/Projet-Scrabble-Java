...
/**
 * Machine learning agent for word search using TensorFlow.
 * This class loads a pre-trained model to predict valid dictionary words
 * based on the letters available in a player's rack.
 */
public class MLAgent implements AutoCloseable {
  ...
  public MLAgent(String modelPath, List<String> dictionary) {
    ...
    if (!modelDir.exists() || !modelDir.isDirectory()) {
      System.out.println(
          "[ML] Model directory not found at '" 
          + modelPath 
  ...
  /**
   * Predicts the best words to form given a string representing the player's rack.
